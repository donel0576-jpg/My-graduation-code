<template>
  <div>
    <div class="card" style="margin-bottom: 5px">
      <el-input clearable @clear="load" style="width: 260px; margin-right: 5px" v-model="data.userName" placeholder="请输入购买人查询" :prefix-icon="Search"></el-input>
    ...
    <div class="card" style="margin-bottom: 5px">
      <el-table :data="data.tableData" style="width: 100%" :header-cell-style="{ color: '#333', backgroundColor: '#eaf4ff' }">
        <el-table-column prop="bookImg" label="产品封面">
        ...
        <el-table-column prop="bookName" label="产品名字" />
        <el-table-column prop="bookAuthor" label="产品负责人" />
